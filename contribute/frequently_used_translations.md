...
Terms useful to teachers are mostly towards the beginning of the table as well as in the [listing of different assignment category names](#assignment-categories).
The table is quite extensive to support improving user interface texts.
...
If the first cell ('Term') of the row is empty, the row corresponds to another translation of the term listed above.
...
| **Relate to courses** |
| course        | kurssi        |               |               |               |               |
| course instance | kurssikerta | | *URL-identifier for this course instance* | (course) offering, e.g. "fall offering of --" | x |
| course module | kurssimoduuli |               |               |               |               |
| module        | moduuli       |               |               |               |               |
| chapter       | luku          |               |               |               |               |
| assignment    | tehtävä       |               |               |               |               |
| enrolment questionnaire | ilmoittautumiskysely | |            |               | x             |
| feedback      | palaute       |               |               |               |               |
| learning object | oppimissisältö | Generally used to mean something else than when used in A+; probably should be replaced with something else, oppimisisältö is unclear as well | | oppimisolio | x |
| model answer  | esimerkkiratkaisu |           |               |               | x             |
| submission    | palautus      |               |               |               |               |
|               |               |               |               |               |               |
| assignment category | tehtäväkategoria | A category used to classify and categorize assignments, and to define settings, e.g. 'accept unofficial submissions' | | | x |
| assignment info | tehtävän tiedot |           |               |               |               |
| confirmed     | vahvistettu   | A submission or points which are not unconfirmed | | |        |
| unconfirmed   | vahvistamaton | A submission whose points are not counted YET toward the grade due to missing a submission to a "confirm level" exercise (such as mandatory feedback), or the points of such a submission | | | |
| course diploma | kurssidiplomi |              |               |               |               |
| course language | kurssikieli |               |               |               |               |
| deadline      | määräaika     |               | *deadline deviations*, *deadline for the assignment* | | |
| deadline  deviation | määräajan poikkeama |   |               |               |               |
| early access  | aikainen pääsy |              |               |               |               |
| enrolment     | ilmoittautuminen |            |               |               |               |
| enrolment audience | ilmoittautumisen kohdeyleisö | |         |               |               |
...
| main navigation | päävalikko  | top bar on desktop, options under heading "Site" on mobile | *skip main navigation* | | | 
| navigation    | valikko       |               |               |               |               |
...
| -             | Voluntary exercises | -       | Optional assignments for practice | Theory of computation | |
